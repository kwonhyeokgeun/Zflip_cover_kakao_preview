package com.kun.zflipcoverkakopreview.db.dao
...
interface TalkDao {
    ...
    @Query("SELECT Talk.*, Member.name, Member.profile_img FROM Talk INNER JOIN Member ON Talk.member_id = Member.id WHERE Talk.id = :talkId LIMIT 1500")
